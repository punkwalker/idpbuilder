...
func (in *AWSAgentStatus) DeepCopyInto(out *AWSAgentStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSAgentStatus.
func (in *AWSAgentStatus) DeepCopy() *AWSAgentStatus {
	if in == nil {
		return nil
	}
	out := new(AWSAgentStatus)
	in.DeepCopyInto(out)
	return out
}
